...
namespace signal_detail
{
    ...
    */
    ...
    {
        public:
            using signal_base<Signature>::private_emit;
            using signal_base<Signatures...>::private_emit;
    ...
    private signal_detail::signal_base<Signature...>
{
    ...
    public:
        ...
        void emit(Args... args)
        {
            private_emit(std::forward<Args>(args)...);
        }

    private:
        using signal_detail::signal_base<Signature...>::private_emit;
};
